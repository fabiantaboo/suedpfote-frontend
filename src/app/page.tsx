      ...
      <section className="pt-32 pb-20 px-6 overflow-hidden">
        <div className="max-w-3xl mx-auto text-center relative">
          ...
          <p className="text-xl text-zinc-500 max-w-xl mx-auto leading-relaxed relative">
            Premium Produkte, designed fÃ¼r LinkshÃ¤nder. 
        ...
        <div className="animate-marquee whitespace-nowrap flex gap-8">
          {[...Array(3)].map((_, i) => (
            <div key={i} className="flex gap-8 text-zinc-400 text-sm font-medium">
              <span>âœ‚ï¸ Scheren die schneiden</span>
              <span>âœï¸ FÃ¼ller die nicht schmieren</span>
              <span>ðŸ“ Lineale die du lesen kannst</span>
              <span>ðŸ³ KÃ¼chenwerkzeug das funktioniert</span>
              <span>ðŸ–±ï¸ Tech fÃ¼r deine Hand</span>
              <span>â¤ï¸ Made for Lefties</span>
            </div>
          ))}
        </div>
      </section>
      ...
      <section className="py-16 border-b border-zinc-100">
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
          <div className="group">
            ...
            <p className="text-sm text-zinc-500 mt-2">LinkshÃ¤nder in Deutschland</p>
          </div>
          <div className="group">
            <p className="text-5xl font-bold text-zinc-900 group-hover:scale-110 transition-transform">10%</p>
            <p className="text-sm text-zinc-500 mt-2">der WeltbevÃ¶lkerung</p>
          </div>
          <div className="group">
            <p className="text-5xl font-bold text-zinc-900 group-hover:scale-110 transition-transform">100%</p>
            <p className="text-sm text-zinc-500 mt-2">fÃ¼r Links designed</p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-zinc-500 max-w-lg mx-auto text-lg">
              Jedes Produkt wurde speziell fÃ¼r die linke Hand entwickelt. 
              Keine Kompromisse.
            </p>
          </div>
                ...
                <article className="relative">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center justify-between pt-4">
                      ...
                      >
                        {addedId === product.id ? 'âœ“ HinzugefÃ¼gt' : 'In den Warenkorb'}
                      </button>
                    </div>
                  </div>
                </article>
      ...
      <section className="py-20 px-6 bg-gradient-to-b from-zinc-50 to-white">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <blockquote className="text-2xl md:text-3xl font-medium text-zinc-900 leading-relaxed mb-8">
            ...
            nur weil meine Schere fÃ¼r die falsche Hand war."
          </blockquote>
          <cite className="text-zinc-500 not-italic">
            â€” Sarah, Lehrerin aus MÃ¼nchen
          </cite>
        </div>
      </section>
      ...
      <section className="py-20 px-6">
        <div className="max-w-4xl mx-auto bg-zinc-900 rounded-3xl p-12 md:p-16 text-center text-white">
          ...
          <p className="text-xl text-zinc-300 mb-8 max-w-2xl mx-auto">
            Die Welt ist es. Zeit, das zu Ã¤ndern.
          </p>
          <Link 
            href="/story"
      ...
      <section className="py-20 px-6 border-t border-zinc-100">
        <div className="max-w-xl mx-auto text-center">
          ...
          <p className="text-zinc-500 mb-8 text-lg">
            Neue Produkte, Tipps fÃ¼r LinkshÃ¤nder, und 10% auf deine erste Bestellung.
          </p>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-zinc-500">Ab 50â‚¬ Bestellwert</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              <div className="w-12 h-12 bg-blue-100 rounded-full flex items-center justify-center">
                <span className="text-2xl">â†©ï¸</span>
              </div>
              <p className="font-medium text-zinc-900">30 Tage RÃ¼ckgabe</p>
            ...
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-zinc-500">SSL-verschlÃ¼sselt</p>
            </div>
            <div className="flex flex-col items-center gap-2">
              ...
              <p className="text-sm text-zinc-500">Von LinkshÃ¤ndern</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-6 bg-zinc-50" id="faq">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-zinc-600 text-center mb-12">
            Alles was du Ã¼ber LinkshÃ¤nder-Produkte wissen musst
          </p>

          <div className="space-y-4">
            {[
              {
                q: "Warum brauche ich spezielle LinkshÃ¤nder-Produkte?",
                a: "Die meisten Alltagsprodukte sind fÃ¼r RechtshÃ¤nder designt. Scheren, FÃ¼ller, KÃ¼chengerÃ¤te - alles ist spiegelverkehrt aufgebaut. Das fÃ¼hrt bei LinkshÃ¤ndern zu ErmÃ¼dung, schlechteren Ergebnissen und Frustration. Unsere Produkte sind ergonomisch fÃ¼r die linke Hand entwickelt und machen den Unterschied spÃ¼rbar."
              },
              {
                q: "Sind LinkshÃ¤nder-Scheren wirklich anders?",
                a: "Ja! Bei einer LinkshÃ¤nder-Schere sind die Klingen vertauscht. Wenn du mit der linken Hand schneidest, drÃ¼ckst du automatisch nach innen - genau wie die Klingen zusammengedrÃ¼ckt werden. Bei RechtshÃ¤nder-Scheren drÃ¼cken LinkshÃ¤nder die Klingen auseinander, was zu unsauberen Schnitten fÃ¼hrt."
              },
              {
                q: "Wie lange dauert der Versand?",
                a: "Wir versenden innerhalb von 1-2 Werktagen. Die Lieferung dauert in Deutschland 2-4 Werktage. Ab 50â‚¬ Bestellwert ist der Versand kostenlos!"
              },
              {
                q: "Kann ich Produkte zurÃ¼ckgeben?",
                a: "SelbstverstÃ¤ndlich! Du hast 30 Tage Zeit, Produkte ohne Angabe von GrÃ¼nden zurÃ¼ckzugeben. Wir erstatten den vollen Kaufpreis."
              },
              {
                q: "Sind alle Produkte fÃ¼r LinkshÃ¤nder geeignet?",
                a: "Ja, 100%! Jedes Produkt bei SÃ¼dpfote ist speziell fÃ¼r LinkshÃ¤nder entwickelt oder ausgewÃ¤hlt. Wir testen alles selbst - denn wir sind auch LinkshÃ¤nder."
              }
            ].map((faq, i) => (
              <details key={i} className="group bg-white rounded-2xl shadow-sm">
                <summary className="flex justify-between items-center cursor-pointer p-6 font-medium text-zinc-900">
                  {faq.q}
                  <span className="ml-4 text-zinc-400 group-open:rotate-180 transition-transform">â–¼</span>
                </summary>
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              "mainEntity": [
                {
                  "@type": "Question",
                  "name": "Warum brauche ich spezielle LinkshÃ¤nder-Produkte?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Die meisten Alltagsprodukte sind fÃ¼r RechtshÃ¤nder designt. Scheren, FÃ¼ller, KÃ¼chengerÃ¤te - alles ist spiegelverkehrt aufgebaut. Das fÃ¼hrt bei LinkshÃ¤ndern zu ErmÃ¼dung, schlechteren Ergebnissen und Frustration. Unsere Produkte sind ergonomisch fÃ¼r die linke Hand entwickelt."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Sind LinkshÃ¤nder-Scheren wirklich anders?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Ja! Bei einer LinkshÃ¤nder-Schere sind die Klingen vertauscht. Wenn du mit der linken Hand schneidest, drÃ¼ckst du automatisch nach innen - genau wie die Klingen zusammengedrÃ¼ckt werden."
                  }
                },
                {
                  "@type": "Question",
                  ...
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Wir versenden innerhalb von 1-2 Werktagen. Die Lieferung dauert in Deutschland 2-4 Werktage. Ab 50â‚¬ Bestellwert ist der Versand kostenlos!"
                  }
                },
                {
                  "@type": "Question",
                  "name": "Kann ich Produkte zurÃ¼ckgeben?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "SelbstverstÃ¤ndlich! Du hast 30 Tage Zeit, Produkte ohne Angabe von GrÃ¼nden zurÃ¼ckzugeben. Wir erstatten den vollen Kaufpreis."
                  }
                },
                {
                  "@type": "Question",
                  "name": "Sind alle Produkte fÃ¼r LinkshÃ¤nder geeignet?",
                  "acceptedAnswer": {
                    "@type": "Answer",
                    "text": "Ja, 100%! Jedes Produkt bei SÃ¼dpfote ist speziell fÃ¼r LinkshÃ¤nder entwickelt oder ausgewÃ¤hlt."
                  }
                }
              ]
            })
